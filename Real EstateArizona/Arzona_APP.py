...
# file_path = "Zillow Data Completed2.xlsx"
...
#     return dates, prices, phone, listed_by
...
# dates, prices, phone, listed_by = prepare_plot_data(df, selected_address)
...
# # Load the Excel file and list the available sheets
# file_path = "Zillow Data Completed3.xlsx"
# xls = pd.ExcelFile(file_path)
# sheet_names = xls.sheet_names
...
#     return dates, prices, phone, listed_by, zillow_link
...
# # Prepare data for plotting
# dates, prices, phone, listed_by, zillow_link = prepare_plot_data(df, selected_address)
...
# # Display address information
# if phone or listed_by or zillow_link:
#     st.sidebar.subheader("Address Information")
#     if phone:
#         st.sidebar.write(f"**Phone:** {phone}")
#     if listed_by:
...
#     dates, prices = [], []
#     phone, listed_by, zillow_link = None, None, None
#     bedrooms, bathrooms, area_sqft, days_on_zillow = None, None, None, None
...
#     return dates, prices, phone, listed_by, zillow_link, bedrooms, bathrooms, area_sqft, days_on_zillow
...
# # Prepare data for plotting
# dates, prices, phone, listed_by, zillow_link, bedrooms, bathrooms, area_sqft, days_on_zillow = prepare_plot_data(df, selected_address)
...
# # Display address information
# if phone or listed_by or zillow_link or bedrooms or bathrooms or area_sqft or days_on_zillow:
#     st.sidebar.subheader("Address Information")
#     if phone:
#         st.sidebar.write(f"**Phone:** {phone}")
#     if listed_by:
